                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    ...
                    <form action="admin/user/sua/{{$user->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Tên </label>
                            <input class="form-control" name="name" value="{{$user->name}}" placeholder="Nhập tên của bạn "/>
                        </div>
                        <div class="form-group">
                            <label>email </label>
                            <input class="form-control" name="email" type="email" value="{{$user->email}}" placeholder="Nhập email của bạn "/>
                        </div>
                        <div class="form-group">
